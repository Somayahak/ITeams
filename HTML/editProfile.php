...
<!--///////////////////////////////////////////////////////////////////////////////////////////////-->
			...
			<input id="freeform" name="lname" value="<?php echo $row['lastName']; ?>" style=" background-color:#e0d9ef;border-radius: 5px; margin-bottom: 30px;height:50px; width:48%; resize:none; padding:12px 20px;">
			</span>
