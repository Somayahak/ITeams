            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="..//index.html">How It Works?</a></li>
                        <li class="nav-item"><a class="nav-link" href="..//HTML/logIn.html">Log In</a></li>
                        <li class="nav-item"><a class="nav-link" href="..//HTML/signUp.html">Sign Up</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="containers" style="height:900px; margin-bottom:50px;  margin-top:50px">
            <div class="card" style="height:850px;">
                ...
                <div class="container rform">
                    ...
                    <form action="..//php/registeration.php" method="post" id="regForm">
                        ...
                        <div class="tab">
                            ...
                            <div class="formcontrol">
                                ...
                                <label for="education"><b style=color:#313C41>Education</b></label><span
                                    style="color:#703589"> *</span>
                                <br />
                                <select id="education" name="education" style="width: 100%; height:40px" required>
                                    <option value="" disabled selected value>-- Please select --</option>
                                    <option value="01">Undergraduate</option>
                                    <option value="02">Bachelor Degree</option>
                                    <option value="03">Master Degree</option>
                                    <option value="04">Doctoral Degree</option>
                                </select>
                                <i class="fas fa-check-circle"></i>
                                <i class="fas fa-exclamation-circle"></i>
                                <small>Error message</small>
