...
<head>
    ...
    <title>ITeams Find team members</title>
    <!--person icon-->
        ...
        <form action="..//HTML/signUp2.html">
            ...
            <div class="containers" style="height:670px; margin-bottom:50px;  margin-top:50px">
                <div class="card flex" style="height:730px; background-color: #fff;width: 800px;">
                    <label for="freeform" style="font-size: 20px; color:#703589;"><b>Recommended Users</b></label>
                    <div class="px-3 ex1" style="height: inherit;">
